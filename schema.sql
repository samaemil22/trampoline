...
-- Seed default games if table empty
INSERT INTO games (name, duration, price)
SELECT 'ترامبولين', 30, 50.00 WHERE NOT EXISTS (SELECT 1 FROM games WHERE name = 'ترامبولين' AND duration = 30);
INSERT INTO games (name, duration, price)
SELECT 'ترامبولين', 60, 90.00 WHERE NOT EXISTS (SELECT 1 FROM games WHERE name = 'ترامبولين' AND duration = 60);
